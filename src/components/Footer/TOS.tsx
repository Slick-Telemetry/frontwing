    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to Slick Telemetry.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Slick Telemetry, accessible from{' '}
          <a
            href='https://slicktelemetry.com'
            rel='external nofollow noopener'
            target='_blank'
          >
            https://slicktelemetry.com
          </a>
        </p>
      </li>
      <li>
