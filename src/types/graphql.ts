...
export type MapHeader_ScheduleFragmentFragment = {
  __typename?: 'schedule';
  event_name?: string | null;
  round_number?: number | null;
  event_date?: string | null;
...
} & { ' $fragmentName'?: 'MapTopRaceDriversFragment' };
...
export type GetTopStandingsQuery = {
  __typename?: 'query_root';
  drivers: Array<{
    __typename?: 'drivers';
    abbreviation?: string | null;
...
export const MapHeader_ScheduleFragmentFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
...
} as unknown as DocumentNode<MapTopRaceDriversFragment, unknown>;
  ...
  definitions: [
    {
      ...
      operation: 'query',
      name: { kind: 'Name', value: 'GetSeasonEvents' },
      variableDefinitions: [
        {
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetEventSchedule' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'year' } },
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            alias: { kind: 'Name', value: 'dropdown_events' },
            name: { kind: 'Name', value: 'schedule' },
            arguments: [
              {
                kind: 'Argument',
          ...
          },
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'official_event_name' },
                },
                { kind: 'Field', name: { kind: 'Name', value: 'event_name' } },
                {
                  kind: 'Field',
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                    ...
                    selections: [
                      {
                        ...
                        name: {
                          kind: 'Name',
                          value: 'scheduled_start_time_utc',
                        },
                      },
                      { kind: 'Field', name: { kind: 'Name', value: 'name' } },
                      {
                ...
                {
                  kind: 'Field',
                  alias: { kind: 'Name', value: 'practices' },
                  name: { kind: 'Name', value: 'sessions' },
                  arguments: [
                    {
                      kind: 'Argument',
...
>;
export const GetTopStandingsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetTopStandings' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
  ...
  GetTopStandingsQuery,
  GetTopStandingsQueryVariables
>;
